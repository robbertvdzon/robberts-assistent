...
class UpdateChecker {
  ...
  /// (zie [checkSelf]), los van de volledige 3-apps-lijst in het Updates-tabblad.
  static const selfPackageName = 'nl.vdzon.robberts_assistent';

  Future<List<AppUpdateInfo>> checkAll() => Future.wait(_apps.map(_checkOne));

  /// Checkt alleen deze app zelf (i.p.v. alle drie) — voor de niet-blokkerende opstart-check.

...
private val SYSTEM_PROMPT = """
    ...
    stories en actiepunten uit de software factory op te halen, om reminders te zetten
    (push-notificatie op tijd, eenmalig of herhalend), om alarms te zetten (een echte wekker op de
    telefoon, eenmalig of herhalend), om Robberts agenda te lezen, om een Google Doc te lezen, en
    om een push-notificatie naar Robberts telefoon te sturen. Kies een reminder als een melding
    ...
    fun assistantChatClient(
        ...
        ChatClient.builder(chatModel)
            ...
            .defaultTools(
                ...
                automowerTools, stravaTools, softwareFactoryTools, reminderTools, alarmTools, calendarTools,
                docsTools, pushTools,
            )
            .build()

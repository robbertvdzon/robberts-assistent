...
/**
 * Opslag-poort voor de moestuin-foto's. Fallback is [InMemoryPhotoStorage] (ephemeral); met
 * Firebase geconfigureerd kiest [GardenStoreConfig] de [FirebaseStoragePhotoStorage].
 */

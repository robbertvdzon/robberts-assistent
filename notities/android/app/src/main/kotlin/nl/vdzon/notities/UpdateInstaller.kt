...
/**
 * Native hulp voor de "nieuwe versie beschikbaar?"-opstartcheck (Flutter kan de geïnstalleerde
 * versie/package-installer niet zelf aanroepen). Blootgesteld via een MethodChannel in
 * [MainActivity]. Zelfde recept als robberts_assistent's `UpdateInstaller.kt`.
 */

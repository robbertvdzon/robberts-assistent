...
- **`robberts_assistent/`** — bottom-navigatie met 5 tabs. Eerste tab is **"Upcoming"**
  ...
  de systeemstatus-sectie van diezelfde `GET /api/v1/briefing`-respons (geen apart
  backend-endpoint), per onderdeel (Zonnepanelen/Backups/OpenShift/Robotmaaier/Software Factory)
  een kop (`BriefingItem.heading`, nieuw optioneel veld) met daaronder de ruwe, niet-AI-
  ...
  AI-samenvatting gebaseerd; alleen deze nieuwe tab toont de ruwe per-check data. Daarnaast:
  chat-assistent met
